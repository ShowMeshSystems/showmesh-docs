...
| [Audio node](./audio-nodes/) | Play and mix node-local audience audio, provide controlled fades and announcements, and generate LTC on a discrete same-clock output. | Planned; unmerged preview is not deployable |
