...
<CardGrid>
  ...
  <Card title="Audio node" icon="warning">
    ...
    Audio-node software covers configuration, session control, gain/output control, and LTC generation, but ShowMesh has no supported sound-producing installation path or commissioned hardware workflow. [Read the audio preview →](/guides/set-up-an-audio-node/)
  </Card>
...
- an audio installation guide after hardware commissioning proves routing, LTC alignment, and failure behavior;
